...
public class issu_itemClass {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					issu_itemClass window = new issu_itemClass();
	...
	private void initialize() {
		...
		frmIssueItems.setFont(new Font("Dialog", Font.BOLD, 16));
		frmIssueItems.setTitle("Item");
