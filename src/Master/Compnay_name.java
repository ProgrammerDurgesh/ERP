...
public class Compnay_name {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Compnay_name window = new Compnay_name();
	...
	private void initialize() {
		...
		frmAddmesurmentunit.setTitle("Compnay Name");
		...
		Object[] column = {"Compnay Name ","Description"};
		...
		JLabel lblNewLabel = new JLabel("Compnay Name");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				else
				{
					...
					String s="insert into  compnaynamedetails values(?,?)";	
